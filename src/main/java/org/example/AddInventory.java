...
public class AddInventory extends JLayeredPane {
    ...
    public AddInventory(int mealID, JPanel leftContentPanel) {
        ...
        // Create main panel that will hold all components
        ...
        warningIcon.setFont(new Font("Inter", Font.BOLD, 35));
    ...
    private void updateWarningVisibility() {
        warningIcon.setVisible(quantityAvailable < 5);
    }
    ...
    public void updateQuantityLabel(int newQuantity) {
        if (newQuantity >= 0) {
            ...
            updateWarningVisibility();
            // Repaint the panel to reflect UI changes
            this.revalidate();
            this.repaint();
        } else {
